...
CreateLambdaConvar( "lambdaplayers_friend_enabled", 1, true, false, false, "允许 Lambda Player 成为玩家或者其他 Lambda Player 的好友", 0, 1, { name = "启用好友模块", type = "Bool", category = "Friend System" } )
CreateLambdaConvar( "lambdaplayers_friend_friendlyfire", 0, true, false, false, "允许好友之间相互造成伤害", 0, 1, { name = "启用好友伤害", type = "Bool", category = "Friend System" } )
CreateLambdaConvar( "lambdaplayers_friend_drawhalo", 1, true, true, false, "在好友身上绘制发光轮廓", 0, 1, { name = "绘制光环", type = "Bool", category = "Friend System" } )
CreateLambdaConvar( "lambdaplayers_friend_friendcount", 3, true, false, false, "玩家和 Lambda Player 所能拥有的最大好友数量", 1, 30, { name = "好友数量限制", type = "Slider", decimals = 0, category = "Friend System" } )
CreateLambdaConvar( "lambdaplayers_friend_friendchance", 5, true, false, false, "Lambda Player 在生成时成为玩家或者其他 Lambda Player 好友的几率", 1, 100, { name = "好友几率", type = "Slider", decimals = 0, category = "Friend System" } )
